...
class _FotoBuluntuState extends State<FotoBuluntu> {
      ...
      if (image != null) {
        ...
        if (imageFile.lengthSync() > 64000) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text("Fotoğrafın boyutu çok fazla!")));
        }
      }
    });
  }
  ...
  Future<void> Upload() async {
    ...
    var url = 'https://db9a-85-96-210-113.ngrok.io/mobiledb/item/iteminsert.php';
    ...
    if (response.statusCode == 200 && data == "Success") {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Kayip Eşya Eklendi!")));
    } else {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Gönderme İşlemi Başarısız.")));
    }
  }
              ...
              onSelected: (value) {
                if (value == 1) {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => MainHelp()));
                }
              },
              itemBuilder: (context) => [
                    PopupMenuItem(
                          ...
                          Positioned(
                            ...
                            child: PopupMenuButton(
                                ...
                                itemBuilder: (context) => [
                                      PopupMenuItem(
                                        padding:
                                            EdgeInsets.only(right: 0, left: 8),
                                        child: Row(
                                          children: [
